...
DEFAULT_PERMISSIONS: Dict[str, Dict[str, bool]] = {
    "owner": {
        ...
        "settings.general": True, "settings.appearance": True, "settings.analytics": True,
        "settings.content": True, "settings.maintenance": True,
    ...
    "admin": {
        ...
        "settings.read": True, "settings.edit": True,
        "settings.general": True, "settings.appearance": True, "settings.analytics": True,
        "settings.content": True, "settings.maintenance": False,
    ...
    "member": {
        ...
        "settings.general": False, "settings.appearance": False, "settings.analytics": False,
        "settings.content": False, "settings.maintenance": False,
        "team.read": True, "team.edit": False, "team.delete": False,
